...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="rounded-xs ring-offset-background focus:outline-hidden focus:ring-ring data-[state=open]:bg-secondary absolute right-10 top-10 opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
