        ...
        <Table className="bg-white">
          <TableHeader>
            <TableRow className="bg-emphasis hover:bg-emphasis">
              <TableHead className="bg-emphasis sticky left-0 w-[52px] whitespace-nowrap text-center font-bold !text-white" />
              ...
              <TableHead className="bg-emphasis sticky right-0 w-[52px] whitespace-nowrap text-center font-bold text-white after:absolute after:bottom-0 after:left-0 after:top-0 after:block after:w-[30px] after:translate-x-[-100%] after:content-[''] after:[box-shadow:inset_-10px_0_8px_-8px_rgba(5,5,5,0.06)]">
                アクション
              </TableHead>
            </TableRow>
          </TableHeader>
              ...
              >
                {data.map((item, index) => (
                  <SortableRow id={item.name} key={item.name}>
                    {disabled ? (
                      <TableCell className="bg-background sticky left-0 w-[48px]">
                        <div>
                          <Button
                            size="icon"
                            variant="ghost"
